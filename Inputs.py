'''
        These 4 parameters are required as input for the state space system. These must be taken from the flight data
...
'''
        First specify the mass before using the other parameters
# Aircraft mass
m      = 10000            # mass [kg]
'''

# aerodynamic properties (from table C, but have to be calculated from own data)
e      = 0.8                # Oswald factor [ ]
