...
plt.grid()
plt.ylabel('Roll angle change [degree]')
plt.xlabel('Time [s]')
plt.subplot(2,2,3)
plt.plot(T, rollrate_sim)
plt.grid()
plt.ylabel('Roll rate change [degree/s]')
plt.xlabel('Time [s]')
plt.subplot(2,2,4)
plt.plot(T, yawrate_sim)
plt.grid()
plt.ylabel('Yaw rate change [degree/s]')
plt.xlabel('Time [s]')
plt.show(1)